...
export type AppState = { courtNames: string[]; announcement: string; autoMatch: boolean; waiting: WaitingPlayer[]; pending: WaitingPlayer[]; playing: PlayingMatch[]; courtCount: number; avgMatchDuration?: number; matchMode?: string }
export type Player = WaitingPlayer;