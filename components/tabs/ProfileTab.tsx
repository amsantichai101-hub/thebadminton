             ...
             <>
               ...
               <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm mb-6 relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 mb-6 relative z-10">
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center text-2xl font-black shadow-lg ${getSkillColor(Math.ceil(getMySkillLevel()))}`}>{myProfile.name.charAt(0)}</div>
                    <div>
                      ...
                      <div className="mt-1.5"><span className="text-[10px] font-bold bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2 py-1 rounded-full border border-blue-200 dark:border-blue-800 shadow-sm">{getSkillName(Math.ceil(getMySkillLevel()))}</span></div>
                    </div>
                  </div>
